...
function verifyPage(res, code, wantJson) {
  ...
  const page = (inner) => `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Lyceum · Certificate ${esc(code)}</title><style>body{font:16px/1.55 -apple-system,Inter,system-ui,sans-serif;background:#0a0a0b;color:#f2f3f4;margin:0;padding:40px 20px}main{max-width:560px;margin:0 auto;background:#161719;border-radius:22px;padding:28px}h1{font-size:22px;margin:0 0 6px}.ok{color:#4ade80;font-weight:600}.bad{color:#fb7185;font-weight:600}dl{display:grid;grid-template-columns:max-content 1fr;gap:6px 16px;margin:18px 0}dt{color:#8b9097}dd{margin:0}.mono{font-family:ui-monospace,Menlo,monospace;font-size:13px;color:#8b9097;word-break:break-all}.note{font-size:13px;color:#8b9097;margin-top:18px}</style></head><body><main>${inner}<p class="note">Lyceum is an independent study tool, not an accredited institution. Certificates confer no academic credit.</p></main></body></html>`;
